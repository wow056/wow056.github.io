    ...
    <div className="grid items-end justify-items-stretch min-h-screen font-[family-name:var(--font-pretendard)] tracking-[-0.03em]">
      ...
      <main id="main" className="flex flex-col items-stretch">
        <article id="Bio" className="flex flex-col min-h-screen bg-white">
          <Section num={1} title={"Bio"} className="top-0" />
          <div className="grow flex flex-col gap-7 items-stretch min-h-screen justify-center px-5 md:pl-[29.6875%] md:pr-[7.8125%]">
          ...
          <article id="Career" className="flex flex-col grow bg-[#FAFAFA]">
            <Section
              num={2}
              title={"Career"}
              className="md:top-[112px] top-[63px]"
            />
            ...
            >
              <Section num={3} title={"Projects"} 
              className="md:top-[224px] top-[126px]"/>
              ...
              <article id="Skills" className="flex flex-col bg-[#ECECEC]">
                <Section num={4} title={"Skills"}
              className="md:top-[336px] top-[189px]" />
              ...
              className="md:top-[448px] top-[252px]"/>
